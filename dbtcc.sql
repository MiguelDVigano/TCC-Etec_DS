...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 03, 2025 at 06:57 PM
...
(12, 'assunto de teste', 'danvshdvajhdawsdwasd', '2025-09-17 15:45:47', 1, 1, '2025-09-17 18:45:47', '2025-09-17 18:45:47', '2025-09-16 15:45:00');
...
(11, 8, 1, '2025-09-17 15:46:01'),
(12, 6, 1, '2025-09-17 15:46:02'),
(13, 2, 1, '2025-09-17 15:46:02'),
(14, 11, 1, '2025-09-17 15:46:02'),
(15, 10, 1, '2025-09-17 15:46:03'),
(16, 5, 1, '2025-09-17 15:46:03'),
(17, 4, 1, '2025-09-17 15:46:03'),
(18, 3, 1, '2025-09-17 15:46:04');
...
INSERT INTO `reserva` (`id_reserva`, `id_sala`, `id_professor`, `id_turma`, `data_reserva`, `periodo_inicio`, `periodo_fim`, `hora_inicio`, `hora_fim`, `observacao`, `created_at`) VALUES
(1, 1, 2, 3, '2025-12-03', 1, 1, '07:10:00', '08:00:00', 'Teste de reserva periodo 1', '2025-12-02 18:47:09'),
(3, 1, 2, 4, '2025-12-04', 2, 2, '08:00:00', '08:50:00', 'Aula prática de programação\r\n', '2025-12-03 17:56:18');
...
(7, 401, 'Laboratório Química', 'Pratica', 28, 'Ativa', '2025-09-11 18:22:10', '2025-09-18 18:11:28'),
...
--
ALTER TABLE `mensagem_leitura`
  MODIFY `id_leitura` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
ALTER TABLE `reserva`
  ...
  ADD CONSTRAINT `reserva_ibfk_2` FOREIGN KEY (`id_professor`) REFERENCES `usuario` (`id_usuario`),
  ADD CONSTRAINT `reserva_ibfk_3` FOREIGN KEY (`id_turma`) REFERENCES `turma` (`id_turma`);
COMMIT;
